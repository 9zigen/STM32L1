...
#include "stm32l1xx_liquid_crystal.h"
...
void _lcd_init_pins(void) {
	...
	gpio_pinSetup(LCD_E_Port, LCD_E_Pin, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_40MHz);
  /*Configure GPIO pin RS */
  gpio_pinSetup(LCD_RS_Port, LCD_RS_Pin, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_40MHz);
	/*Configure GPIO pin DB4 */
  gpio_pinSetup(LCD_D4_Port, LCD_D4_Pin, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_40MHz);
	/*Configure GPIO pin DB5 */
  gpio_pinSetup(LCD_D5_Port, LCD_D5_Pin, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_40MHz);
	/*Configure GPIO pin DB6 */
  gpio_pinSetup(LCD_D6_Port, LCD_D6_Pin, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_40MHz);
	/*Configure GPIO pin DB7 */
  gpio_pinSetup(LCD_D7_Port, LCD_D7_Pin, GPIO_Mode_OUT, GPIO_OType_PP, GPIO_PuPd_NOPULL, GPIO_Speed_40MHz);
