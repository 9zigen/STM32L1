...
int main(void)
{
	...
	printStringLn(USART1, "System initialized. Initialized jebote!");
	...
	printString(USART1, "\t SCOC:");
	printNumberLn(USART1, MAX11210_read_reg(SCOC), DEC);
	printString(USART1, "\tSOC:");
	printNumberLn(USART1, MAX11210_read_reg(SOC), DEC);
	printString(USART1, "\t SCGC:");
	printNumberLn(USART1, MAX11210_read_reg(SCGC), DEC);
	printString(USART1, "\t SGC:");
	printNumberLn(USART1, MAX11210_read_reg(SGC), DEC);
	...
	while (1)
  {
		...
		printNumberLn(USART1, av_result >> SHIFT, DEC);
		av_result = 0;
