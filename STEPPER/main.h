...
#include <stm32l100rct6_uart.h>
#include <stm32l1xx_stepper.h>

//#include <stm32l1xx_tim_stepper.h>
...
#define S3_EXTI	EXTI_PinSource0	//GPIOB, PB0, external interrupt
#define S4_EXTI EXTI_PinSource1	//GPIOB, PB1, external interrupt
